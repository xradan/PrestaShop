...
class appProdProjectContainer extends Container
{
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : ($this->services['doctrine.dbal.connection_factory'] = new \Doctrine\Bundle\DoctrineBundle\ConnectionFactory([]))) && false ?: '_'}->createConnection(['driver' => 'pdo_mysql', 'host' => '192.168.1.9', 'port' => '', 'dbname' => 'prestashop', 'user' => 'dan', 'password' => 'Ird2019@', 'charset' => 'UTF8', 'driverOptions' => [1002 => 'SET sql_mode=(SELECT REPLACE(@@sql_mode,\'ONLY_FULL_GROUP_BY\',\'\'))'], 'serverVersion' => 5.1, 'defaultTableOptions' => []], new \Doctrine\DBAL\Configuration(), $a, ['enum' => 'string']);
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : ($this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('25XWYAGPbWZFQ0XKxpIchOHjCY7cv1a95BItefasYFMwrxAaK1AiGe3S'))) && false ?: '_'}, '/_fragment');
    }
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('25XWYAGPbWZFQ0XKxpIchOHjCY7cv1a95BItefasYFMwrxAaK1AiGe3S');
    }
    ...
    protected function getDefaultParameters()
    {
        return [
            ...
            'database_host' => '192.168.1.9',
            'database_port' => '',
            'database_name' => 'prestashop',
            'database_user' => 'dan',
            'database_password' => 'Ird2019@',
            'database_prefix' => 'ps_',
            ...
            'secret' => '25XWYAGPbWZFQ0XKxpIchOHjCY7cv1a95BItefasYFMwrxAaK1AiGe3S',
            'ps_caching' => 'CacheMemcache',
            'ps_cache_enable' => false,
            'ps_creation_date' => '2019-09-09',
            'locale' => 'en-US',
            'cookie_key' => 'RvQtk9d07zGqsu3IT4oWuJ2ynHMCZ8IJiCxiod93hEYRm5DUvyXrzqUP',
            'cookie_iv' => 'g2UeY7DS',
            'new_cookie_key' => 'def00000b72275b35e219c46abd6baa9e8a2e0842579db2695872bacc653891455493b6d8b9516491acbf0a2b6bea252d7aa2a77a216cc37c4fcf67db1443dca3d1cbe5a',
            'cache.driver' => 'array',
            ...
            'kernel.secret' => '25XWYAGPbWZFQ0XKxpIchOHjCY7cv1a95BItefasYFMwrxAaK1AiGe3S',
